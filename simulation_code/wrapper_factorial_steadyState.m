...
delayDurations = []; % duration of cue + possible ISI values to be drawn at uniform
...
uniqueConfigs = length(memoryThinning) * length(cue) * length(trueCoherence) * nSub * length(bitNoise);
